...
public class TablaClientes extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tabla.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Identificación", "Nombre", "Direccion de contacto", "Número de contacto", "Mascotas a cargo"
            }
        ) {
    ...
    public void llenarTabla(){
        ...
        List<Cliente> clientes = new ClienteDAOFile().listarCliente();
        for(Cliente cliente : clientes){
            String[] fila = {cliente.getIdentificacion(), cliente.getNombres(), cliente.getDireccionContacto(), cliente.getNumeroContacto()};
            modelo.addRow(fila);
        }
    }
