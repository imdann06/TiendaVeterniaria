...
public class TablaMascotas extends javax.swing.JFrame {
    ...
    /**
     * Creates new form TablaMascotas
     */
    ...
    private void initComponents() {
        ...
        tabla.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "Raza", "Edad", "Nombre", "Fecha de Ingreso", "Genero", "Precio", "Peso" 
            }
        ) {
    ...
    public void llenarTabla(){
        ...
        for(MascotaDTO mascota : mascotas){
            String[] fila = {mascota.getId(), mascota.getRaza(),String.valueOf(mascota.getEdad()), mascota.getNombre(),String.valueOf(mascota.getFechaIngreso()),
                String.valueOf(mascota.getGenero()), String.valueOf(mascota.getPrecio()), String.valueOf(mascota.getPeso())};
            modelo.addRow(fila);
        }
    }
