...
public class TablaVentas extends javax.swing.JFrame {
    ...
    public void llenarTabla(){
        ...
        List<Venta> ventas = new VentaDAOFile().ListarVentas();
        for(Venta venta : ventas){
            String[] fila = {String.valueOf(venta.getFecha()), String.valueOf(venta.getValorVenta()), String.valueOf(venta.getVendedor()), String.valueOf(venta.getCliente())};
            modelo.addRow(fila);
        }
    }
